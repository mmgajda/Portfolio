...
import Project.client.views.ChatHistoryPanel;
...
public class ClientUI extends JFrame implements IClientEvents, ICardControls {
    ...
    public ClientUI(String title) {
        ...
        chatHistoryPanel = new ChatHistoryPanel(this, chatPanel);
        chatPanel.setChatHistoryPanel(chatHistoryPanel);
    ...
    @Override
    public void onAnnouncementReceive(String message) {
        if (currentCard.ordinal() >= Card.CHAT.ordinal()) {
     ...
     */
    @Override
    public void onClientMuteChange(String message, String clientName) {
        userListPanel.textColorForMutedUsers(message, clientName);
    }
